...
import '../widgets/TextInput/text_field.dart';
      ...
      if (validateEmail(email) == true) {
        if (password.length >= 6 &&
          ...
          var dialog = CustomAlertDialog(
            icon: Icons.warning,
            title: 'Warning',
            message: 'Passwords must match and length must be 6 or more',
            onPositivePressed: () {
        ...
        var dialog = CustomAlertDialog(
          icon: Icons.warning,
          title: 'Warning',
          message: 'Please check the formate of email',
          onPositivePressed: () {
            Navigator.of(context).pop();
          },
          positiveBtnText: 'OK',
